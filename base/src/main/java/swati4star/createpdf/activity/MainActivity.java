...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        } else if (i == R.id.nav_camera) {
            fragment = new ImageToPdfFragment();

        } else if (i == R.id.nav_qrcode) {
            fragment = new QrBarcodeScanFragment();

        } else if (i == R.id.nav_gallery) {
            fragment = new ViewFilesFragment();

        } else if (i == R.id.nav_merge) {
            fragment = new MergeFilesFragment();

        } else if (i == R.id.nav_split) {
            fragment = new SplitFilesFragment();

        } else if (i == R.id.nav_text_to_pdf) {
            fragment = new TextToPdfFragment();
        ...
        } else if (i == R.id.nav_extract_images) {
            fragment = new ExtractImagesFragment();

        } else if (i == R.id.nav_remove_pages) {
            fragment = new RemovePagesFragment();
            bundle.putString(BUNDLE_DATA, REMOVE_PAGES);
            fragment.setArguments(bundle);

        } else if (i == R.id.nav_rearrange_pages) {
            fragment = new RemovePagesFragment();
            bundle.putString(BUNDLE_DATA, REORDER_PAGES);
            fragment.setArguments(bundle);

        } else if (i == R.id.nav_compress_pdf) {
            fragment = new RemovePagesFragment();
