...
public class ImageEditor extends AppCompatActivity implements OnFilterItemClickedListener, OnItemClickListner {
    ...
    @BindView(R2.id.nextimageButton)
    ImageButton mNextButton;
    @BindView(R2.id.imagecount)
    TextView mImgcount;
    @BindView(R2.id.previousImageButton)
    ImageButton mPreviousButton;
    @BindView(R2.id.doodleSeekBar)
    SeekBar doodleSeekBar;
    @BindView(R2.id.photoEditorView)
    PhotoEditorView mPhotoEditorView;
    @BindView(R2.id.doodle_colors)
    ...
    @OnClick(R2.id.previousImageButton)
    void previousImg() {
