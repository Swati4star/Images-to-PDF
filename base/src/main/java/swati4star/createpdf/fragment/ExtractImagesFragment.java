...
public class ExtractImagesFragment extends Fragment implements MergeFilesAdapter.OnClickListener,
    ...
    @BindView(R2.id.lottie_progress)
    LottieAnimationView mLottieProgress;
    @BindView(R2.id.selectFile)
    MorphingButton selectFileButton;
    @BindView(R2.id.extractImages)
    MorphingButton extractImagesButton;
    BottomSheetBehavior sheetBehavior;
    @BindView(R2.id.bottom_sheet)
    LinearLayout layoutBottomSheet;
    @BindView(R2.id.upArrow)
    ImageView mUpArrow;
    @BindView(R2.id.downArrow)
    ImageView mDownArrow;
    @BindView(R2.id.layout)
    RelativeLayout mLayout;
    @BindView(R2.id.recyclerViewFiles)
    RecyclerView mRecyclerViewFiles;
    @BindView(R2.id.extracted_files)
    RecyclerView mExtractedFiles;
    @BindView(R2.id.extractedimages_text)
    TextView extractImagesSuccessText;
    @BindView(R2.id.options)
