...
public class ViewFilesFragment extends Fragment
    ...
    @BindView(R2.id.getStarted)
    public Button getStarted;
    @BindView(R2.id.filesRecyclerView)
    RecyclerView mViewFilesListRecyclerView;
    @BindView(R2.id.swipe)
    SwipeRefreshLayout mSwipeView;
    @BindView(R2.id.emptyStatusView)
    ConstraintLayout emptyView;
    @BindView(R2.id.no_permissions_view)
    ...
    @OnClick(R2.id.move_to_home_dir)
    ...
    @OnClick(R2.id.provide_permissions)
