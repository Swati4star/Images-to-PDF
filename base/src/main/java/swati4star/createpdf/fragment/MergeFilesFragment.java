...
public class MergeFilesFragment extends Fragment implements MergeFilesAdapter.OnClickListener, MergeFilesListener,
    ...
    @BindView(R2.id.selectFiles)
    Button mSelectFiles;
    @BindView(R2.id.selected_files)
    RecyclerView mSelectedFiles;
    @BindView(R2.id.enhancement_options_recycle_view)
    ...
    @OnClick(R2.id.selectFiles)
    void startAddingPDF(View v) {
        startActivityForResult(mFileUtils.getFileChooser(),
                INTENT_REQUEST_PICKFILE_CODE);
    }

    @OnClick(R2.id.mergebtn)
